    ...
    <div className="cover bg-gray-100">
      <div className="lg:container p-2 mx-auto">
        <div className="about-banner lg:flex gap-5 mb-6 py-8 justify-between">
          <div className="left mb-8 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] bg-white flex flex-col justify-center p-8 rounded-xl w-full lg:w-[90%] ">
          ...
          <div className="right mb-8 w-full p-2">
        ...
        <div className="founders p-2 mb-12">
          ...
          <div className="profiles flex gap-3 flex-wrap justify-evenly lg:justify-between ">
            ...
            <div class="group bg-white rounded-xl w-[450px]  flex-wrap flex items-center gap-8  transition-all duration-500 p-6  lg:flex-nowrap">
              ...
              <div class="text-center lg:text-left lg:max-w-xs flex-1">
                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                  <h6 class="text-lg text-gray-900 font-semibold mb-1">
                    Harsh Patel
                  </h6>
                ...
                <div class="flex items-center gap-4 justify-center lg:justify-start">
                  <p class="cursor-pointer  text-gray-900 hover:text-white group w-12 h-12 rounded-full flex justify-center items-center bg-gray-100 transition-all duration-500 hover:bg-indigo-600">
                    <svg
                      class="w-5 h-5"
                      width="32"
                      height="32"
        ...
        <div className="facts mb-12 p-2">
          ...
          <div className="profiles flex gap-3 flex-wrap lg:flex-nowrap justify-evenly lg:justify-between ">
            <div className="box w-[500px] mb-2 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-xl overflow-hidden ">
              <div className="info bg-white  py-5 p-8">
            ...
            <div className="box w-[500px] mb-2 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-xl overflow-hidden ">
              <div className="info bg-white p-8">
