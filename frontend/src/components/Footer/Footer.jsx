        ...
        <div className="lg:container mx-auto flex justify-between flex-wrap lg:flex-nowrap ">
          <div className="combine flex flex-wrap sm:flex-nowrap w-full">
            <div className="one w-full px-4 py-2 m-2">
              ...
              <ul>
                <li className="mb-2 text-sm text-gray-700 hover:text-blue-500">
                  <Link to="/">Life</Link>
                </li>
                <li className="mb-2 text-sm text-gray-700 hover:text-blue-500">
            ...
            <div className="four w-full  px-4 py-2 m-2">
              ...
              <ul>
                <li className="mb-2 text-sm text-gray-700 ">
                  <span className="text-black  mr-1">ADDRESS:</span> 7895
                  Piermont Dr NE Albuquerque, NM 198866, United States of
                  America
                </li>
                <li className="mb-2 text-sm text-gray-700 ">
                  <span className="text-black  mr-1">PHONE:</span> +566 4774
                  9930; +566 4774 9940
                </li>
                <li className="mb-2 text-sm text-gray-700 ">
                  <span className="text-black  mr-1">HOURS:</span> all week from
                  9 am to 9 pm
                </li>
                <li className="mb-2 text-sm text-gray-700 ">
      ...
      <div className="footer bg-white p-2">
        <div className="container flex items-center justify-center  px-4 py-2 mx-auto">
          <div className="left-area flex items-center px-2 mb-3 md:mb-0  ">
            <h1 className="text-xl font-semibold">IntelliSource</h1>
            <p className="text-sm  flex item-center text-gray-700 ml-3">
              <span>&#169;</span> IntelliSource 2022. All Rights Reserved
            </p>
          </div>
        </div>
      </div>
